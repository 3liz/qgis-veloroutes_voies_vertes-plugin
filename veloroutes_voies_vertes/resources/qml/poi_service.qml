...
<qgis simplifyDrawingHints="0" maxScale="0" simplifyLocal="1" simplifyMaxScale="1" minScale="1e+08" simplifyDrawingTol="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" version="3.10.5-A Coruña" styleCategories="AllStyleCategories" labelsEnabled="0">
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Restauration" value="RST"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Marché" value="MAR"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Sanitaires" value="WC"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Relais info service" value="RIS"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Relai vélo" value="RV"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Station de gonflage" value="GFG"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Réparation, localtion de vélo" value="RLV"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Aire de pique-nique" value="PIC"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Point d'eau" value="H2O"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    <alias name="" field="description" index="0"/>
