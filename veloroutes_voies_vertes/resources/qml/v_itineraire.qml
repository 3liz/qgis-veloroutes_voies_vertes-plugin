...
<qgis simplifyMaxScale="1" maxScale="1" version="3.10.10-A Coruña" hasScaleBasedVisibilityFlag="1" readOnly="0" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="1" simplifyLocal="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 type="categorizedSymbol" symbollevels="1" enableorderby="0" forceraster="0" attr="niveau_schema">
    <categories>
    ...
    <symbols>
      <symbol clip_to_extent="1" type="line" alpha="1" name="0" force_rhr="0">
        ...
        <layer pass="6" locked="0" class="SimpleLine" enabled="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MM"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontLetterSpacing="0" fontUnderline="0" fontFamily="Ubuntu" fontItalic="0" fontWordSpacing="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontKerning="0" previewBkgrdColor="255,255,255,255" fontStrikeout="0" blendMode="0" fontSize="12" fieldName="nom_officiel" textColor="0,0,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" fontCapitals="0" textOpacity="1" fontSizeUnit="Point" isExpression="0" namedStyle="Regular">
        <text-buffer bufferColor="255,255,255,255" bufferSizeUnits="MM" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferOpacity="1" bufferSize="1" bufferDraw="0" bufferBlendMode="0"/>
        <background shapeRotationType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeType="0" shapeSizeType="0" shapeOffsetY="0" shapeOpacity="1" shapeSVGFile="" shapeJoinStyle="64" shapeSizeUnit="MM" shapeSizeX="0" shapeDraw="0" shapeRotation="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeBorderColor="128,128,128,255" shapeRadiiY="0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeOffsetUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeFillColor="255,255,255,255">
        ...
        <shadow shadowOffsetDist="1" shadowOpacity="0.7" shadowOffsetAngle="135" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowColor="0,0,0,255" shadowRadius="1.5" shadowUnder="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowBlendMode="6" shadowDraw="0" shadowRadiusAlphaOnly="0" shadowScale="100" shadowRadiusUnit="MM" shadowOffsetUnit="MM"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <text-format useMaxLineLengthForAutoWrap="1" multilineAlign="0" wrapChar="" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" decimals="3" rightDirectionSymbol=">" autoWrapLength="0" addDirectionSymbol="0" formatNumbers="0" plussign="0" placeDirectionSymbol="0"/>
      <placement layerType="LineGeometry" placement="3" geometryGenerator="" centroidInside="0" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" offsetType="0" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" priority="10" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" centroidWhole="0" maxCurvedCharAngleOut="-25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" offsetUnits="MM" overrunDistance="0" repeatDistanceUnits="MM" distUnits="MM" preserveRotation="1"/>
      <rendering limitNumLabels="0" displayAll="0" fontLimitPixelSize="0" zIndex="0" scaleMax="1073059" obstacleType="0" drawLabels="1" fontMinPixelSize="3" maxNumLabels="2000" obstacle="1" mergeLines="0" fontMaxPixelSize="10000" scaleMin="1200" labelPerPart="0" scaleVisibility="0" upsidedownLabels="0" obstacleFactor="1" minFeatureSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
  ...
  <aliases>
    <alias index="0" name="Identifiant" field="id_itineraire"/>
    <alias index="1" name="Numéro" field="numero"/>
    <alias index="2" name="Nom officiel" field="nom_officiel"/>
    <alias index="3" name="Nom d'usage" field="nom_usage"/>
    <alias index="4" name="Départ" field="depart"/>
    <alias index="5" name="Arrivée" field="arrivee"/>
    <alias index="6" name="Année d'inscription" field="annee_inscription"/>
    <alias index="7" name="Site web" field="site_web"/>
    ...
    <alias index="11" name="Montant de subvention" field="mont_subv"/>
    <alias index="12" name="Année de subvention" field="annee_subv"/>
    <alias index="13" name="Type pluriannuel" field="type_pluriannuel"/>
    <alias index="14" name="Longueur totale" field="longueur"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="2" exp_strength="0" field="numero" constraints="1"/>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" field="longueur" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig sortExpression="&quot;niveau_schema&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      ...
      <column type="field" name="longueur" width="-1" hidden="0"/>
    </columns>
