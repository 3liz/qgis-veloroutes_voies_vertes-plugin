...
<qgis simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+8" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyLocal="1" version="3.10.14-A Coruña" maxScale="1" labelsEnabled="1" readOnly="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 symbollevels="1" type="categorizedSymbol" attr="niveau_schema" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" value="EUR" symbol="0" label="Européen"/>
      <category render="true" value="NAT" symbol="1" label="National"/>
      <category render="true" value="REG" symbol="2" label="Régional"/>
      <category render="true" value="DEP" symbol="3" label="Départemental"/>
      <category render="true" value="" symbol="4" label=""/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" alpha="1" name="0" force_rhr="0" type="line">
        <layer class="SimpleLine" pass="5" locked="0" enabled="1">
          ...
          <prop k="line_color" v="58,94,202,255"/>
      ...
      <symbol clip_to_extent="1" alpha="1" name="1" force_rhr="0" type="line">
        <layer class="SimpleLine" pass="4" locked="0" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="116,197,203,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="3"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" isExpression="0" textOrientation="horizontal" fontSize="12" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" multilineHeight="1" textColor="0,0,0,255" fontStrikeout="0" namedStyle="Regular" fontWordSpacing="0" fontCapitals="0" fontItalic="0" fontKerning="0" fontFamily="Ubuntu" fontUnderline="0" fontLetterSpacing="0" fontWeight="50" blendMode="0" fieldName="nom_officiel" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point">
        <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferDraw="0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1"/>
        <background shapeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeBorderWidth="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeSizeY="0" shapeJoinStyle="64" shapeOffsetUnit="MM" shapeRadiiX="0" shapeFillColor="255,255,255,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeBlendMode="0" shapeSVGFile="" shapeDraw="0" shapeBorderWidthUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRotation="0" shapeRadiiUnit="MM" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSizeX="0" shapeOffsetY="0" shapeOpacity="1">
        ...
        <shadow shadowRadiusUnit="MM" shadowOffsetDist="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadius="1.5" shadowScale="100" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.7" shadowUnder="0" shadowOffsetUnit="MM" shadowOffsetGlobal="1" shadowColor="0,0,0,255" shadowDraw="0" shadowOffsetAngle="135" shadowRadiusAlphaOnly="0" shadowBlendMode="6"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format plussign="0" reverseDirectionSymbol="0" decimals="3" leftDirectionSymbol="&lt;" formatNumbers="0" wrapChar="" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" addDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">"/>
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="LineGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" centroidInside="0" distUnits="MM" repeatDistanceUnits="MM" xOffset="0" geometryGenerator="" repeatDistance="0" yOffset="0" priority="10" overrunDistanceUnit="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" rotationAngle="0" offsetType="0" preserveRotation="1" maxCurvedCharAngleIn="25" centroidWhole="0" dist="0" quadOffset="4" maxCurvedCharAngleOut="-25" overrunDistance="0" placementFlags="10" placement="3" geometryGeneratorType="PointGeometry"/>
      <rendering labelPerPart="0" fontLimitPixelSize="0" obstacle="1" mergeLines="0" limitNumLabels="0" obstacleFactor="1" minFeatureSize="0" scaleMin="1200" upsidedownLabels="0" displayAll="0" fontMinPixelSize="3" zIndex="0" maxNumLabels="2000" fontMaxPixelSize="10000" scaleMax="1073059" drawLabels="1" scaleVisibility="0" obstacleType="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory scaleBasedVisibility="0" maxScaleDenominator="1e+8" enabled="0" scaleDependency="Area" penWidth="0" sizeType="MM" minScaleDenominator="122926" rotationOffset="270" height="15" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" barWidth="5" lineSizeType="MM" diagramOrientation="Up" penAlpha="255" opacity="1" backgroundColor="#ffffff" penColor="#000000" width="15" minimumSize="0" backgroundAlpha="255" lineSizeScale="3x:0,0,0,0,0,0">
  ...
  <aliases>
    <alias field="id_itineraire" name="Identifiant" index="0"/>
    <alias field="numero" name="Numéro" index="1"/>
    <alias field="nom_officiel" name="Nom officiel" index="2"/>
    <alias field="nom_usage" name="Nom d'usage" index="3"/>
    <alias field="depart" name="Départ" index="4"/>
    <alias field="arrivee" name="Arrivée" index="5"/>
    <alias field="annee_inscription" name="Année d'inscription" index="6"/>
    <alias field="site_web" name="Site web" index="7"/>
    ...
    <alias field="longueur" name="Longueur totale" index="11"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="NULL" field="est_inscrit" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="numero" notnull_strength="2" exp_strength="0" unique_strength="0" constraints="1"/>
  ...
  <attributeactions>
    ...
    <actionsetting capture="0" icon="" id="{7d5d46f5-8ff0-472e-b10d-67234da5ff18}" name="Suppression d'étape sur un itinéraire à partir de portions sélectionnées " action="from qgis.utils import plugins&#xa;plugins['veloroutes_voies_vertes'].run_action('update_selected_feature', [%id_itineraire%],[% '\''||@layer_name||'\'' %], 'del')" shortTitle="Suppression d'étape" type="1" notificationMessage="" isEnabledOnlyWhenEditable="0">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
    <actionsetting capture="0" icon="" id="{d1924987-ac4b-4b36-9747-6ac4d486f86c}" name="Ajouter des étapes à partir de portions sélectionnées" action="from qgis.utils import plugins&#xa;plugins['veloroutes_voies_vertes'].run_action('update_selected_feature', [%id_itineraire%], [% '\''||@layer_name||'\'' %] ,'add')" shortTitle="Ajouter des étapes" type="1" notificationMessage="" isEnabledOnlyWhenEditable="0">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
  </attributeactions>
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;niveau_schema&quot;">
    <columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField showLabel="1" name="id_itineraire" index="0"/>
    <attributeEditorField showLabel="1" name="longueur" index="11"/>
    ...
    <attributeEditorContainer showLabel="1" name="Étapes" visibilityExpression="" groupBox="0" visibilityExpressionEnabled="0" columnCount="1">
      <attributeEditorRelation showLabel="1" showUnlinkButton="1" name="etape_7d2f_id_itineraire_v_itinerai_id_itineraire" showLinkButton="1" relation="etape_7d2f_id_itineraire_v_itinerai_id_itineraire"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
